if (!global.shopOpened)
{
	...
	draw_sprite(spr_bar_border,0,healthbar_x + 1,healthbar_y + 1);

	draw_sprite(spr_syrupbar_bg,0,syrupbar_x,syrupbar_y - 4);
	...
	draw_sprite(spr_bar_border,0,syrupbar_x + 1,syrupbar_y + 1);
}