...
draw_text_transformed_color(room_width/2 - 50,100,"wave:"+string(global.wavecount),3,3, 0, c_white,c_white,c_white,c_white, 1);
draw_text_transformed_color(room_width/2 - 50,150,"butter:"+string(global.buttercount),3,3, 0, c_white,c_white,c_white,c_white, 1);
